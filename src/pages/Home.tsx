    ...
    <div className="min-h-screen bg-[#F0F2FF] font-sans">
      ...
      <header className="relative bg-gradient-to-b from-[#E6E9FF] to-[#F0F2FF] p-4 sm:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative flex items-center justify-end h-32 sm:h-40">
            <img src={doc4Image} alt="健康管家" className="absolute bottom-0 left-0 w-36 sm:w-48 h-auto z-0 mix-blend-multiply" />
            <div className="relative z-10 text-right w-1/2">
              <h1 className="text-lg sm:text-xl font-bold text-gray-800">你好呀, {username}</h1>
              <p className="text-sm sm:text-base text-gray-600">我是你的病例研习管家</p>
              <p className="text-xs text-gray-500 mt-1">开始你的病例研习之旅吧！</p>
            </div>
          </div>
        </div>
      </header>
